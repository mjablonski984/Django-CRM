...
# To use default sqlite db replace ENGINE with: 'django.db.backends.sqlite3' and comment out USER,PASSWORD,HOST&PORT
...
# use dj_database_url to configure DATABASE_URL environment variable for Heroku
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static') # Set static base directory
]

MEDIA_ROOT = os.path.join(BASE_DIR, 'static/images') # Uploaded images will be stored in this location
